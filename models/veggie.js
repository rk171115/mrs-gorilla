...
//   // Method to add old_price_per_unit column to items table
//   static async addOldPriceColumn() {
//     try {
//       console.log('🚀 Adding old_price_per_unit column to items table...');
      
//       // Alter the table to add the new column
//       await pool.query(`
//         ALTER TABLE items 
//         ADD COLUMN old_price_per_unit DECIMAL(10, 2) NULL AFTER price_per_unit
//       `);
      
//       console.log('✅ old_price_per_unit column added successfully!');
//       return true;
//     } catch (error) {
//       console.error('❌ Error adding old_price_per_unit column:', error);
//       return false;
//     }
//   }
// }
...
// //       const addColumnSuccess = await VegetableCartDatabase.addOldPriceColumn();
      
// //       if (initSuccess && updateSuccess && addColumnSuccess) {
// //         console.log('All migrations completed successfully');
// //         process.exit(0);
// //       } else {
// //         console.log('One or more migrations failed');
// //         process.exit(1);
// //       }
// //     } catch (error) {
